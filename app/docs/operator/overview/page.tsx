...
export default function OperatorOverviewPage() {
  return (
    <div className="doc-content">
      ...
      <pre>{`# Base de datos
DATABASE_URL="postgresql://user:pass@host:5432/whale_alert"
...
ALCHEMY_WEBHOOK_SECRET="secreto_para_webhooks_alchemy"

# JWT — MÍNIMO 64 caracteres, generado aleatoriamente
...
# Email (Resend)
RESEND_API_KEY="re_..."
EMAIL_FROM="noreply@humanidfi.com"
